...
var Transition = /** @class */ (function () {
    ...
    Transition.prototype.injector = function (state, pathName) {
        ...
        if (state)
            path = pathUtils_1.PathUtils.subPath(path, function (node) {
    ...
    Transition.prototype.error = function () {
        ...
        if (invalidParams.length) {
            var invalidValues = invalidParams.map(function (param) {
                return "[" + param.id + ":" + strings_1.stringify(values[param.id]) + "]";
            }).join(', ');
    ...
    Transition.prototype.toString = function () {
        ...
        var id = this.$id, from = predicates_1.isObject(fromStateOrName) ? fromStateOrName.name : fromStateOrName,
