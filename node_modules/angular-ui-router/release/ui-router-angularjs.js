    ...
    var UrlRouterProvider = /** @class */ (function () {
        ...
        UrlRouterProvider.injectableHandler = function (router, handler) {
            return function (match) {
                return core.services.$injector.invoke(handler, null, {
                    $match: match,
        ...
        UrlRouterProvider.prototype.rule = function (ruleFn) {
            ...
            var match = function () {
                return ruleFn(core.services.$injector, _this.router.locationService);
            };
        ...
        UrlRouterProvider.prototype.otherwise = function (rule) {
            ...
            if (core.isString(rule)) {
                ...
                urlRules.otherwise(function () {
                    return rule(core.services.$injector, _this.router.locationService);
                });
            } else {
        ...
        return {
            ...
            compile: function (tElement) {
                ...
                return function (scope, $element) {
                    ...
                    if (controller) {
                        var controllerInstance = ($controller(controller, core.extend({}, locals, {
                            $scope: scope,
                            $element: $element
                        })));
                        if (controllerAs) {
